...
<Project Type="Project" LVVersion="20008000">
	...
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="Type Definitions" Type="Folder">
			...
			<Item Name="EnableDisableControls.ctl" Type="VI" URL="../controls/EnableDisableControls.ctl"/>
			<Item Name="ChangeServoPosition.ctl" Type="VI" URL="../controls/ChangeServoPosition.ctl"/>
		</Item>
		<Item Name="SubVIs" Type="Folder">
			<Item Name="ChangeServoPosition.vi" Type="VI" URL="../SubVIs/ChangeServoPosition.vi"/>
			<Item Name="CheckConnection.vi" Type="VI" URL="../SubVIs/CheckConnection.vi"/>
			<Item Name="CreateLogFiles.vi" Type="VI" URL="../SubVIs/CreateLogFiles.vi"/>
			<Item Name="CreateLogMessage.vi" Type="VI" URL="../SubVIs/CreateLogMessage.vi"/>
			<Item Name="CreateSetTargetCommand.vi" Type="VI" URL="../SubVIs/CreateSetTargetCommand.vi"/>
			<Item Name="EnableDisableCtls.vi" Type="VI" URL="../SubVIs/EnableDisableCtls.vi"/>
			<Item Name="ShowHideInstructions.vi" Type="VI" URL="../SubVIs/ShowHideInstructions.vi"/>
		</Item>
		...
		<Item Name="Build Specifications" Type="Build">
			<Item Name="Main Application" Type="EXE">
				...
				<Property Name="Destination[0].path" Type="Path">../builds/NI_AB_PROJECTNAME/Main Application/Robot.exe</Property>
				...
				<Property Name="Source[0].itemID" Type="Str">{B4CB5089-9731-4541-BAA8-B9C20B0443C6}</Property>
